...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        ...
        let selected = i == 0 ? currency_code == "USD" ? "selected" : "" : currency_code == "CDF" ? "selected" : "";
...
function getExchangeRate(){
    ...
    /* update the api on the following link */


    
    let url = `https://v6.exchangerate-api.com/v6/2e4456fb16a9b11661c2b472/latest/${fromCurrency.value}`;
